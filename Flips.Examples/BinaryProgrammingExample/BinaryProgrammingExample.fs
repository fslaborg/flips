...
let solve settings =
    let model, objective = SampleProblems.BinaryProgrammingExample.model
    ...
    | Optimal solution ->
        ...
        CsvExport.exportVariablesToFile "binary.programming" solution.DecisionResults CsvExport.csvConfig
