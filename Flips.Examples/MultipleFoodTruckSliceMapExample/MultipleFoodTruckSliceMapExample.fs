...
let solve settings =
    ...
    let model, objective = SampleProblems.MultipleFoodTruckWithSliceMapExample.model
    ...
    | Optimal solution ->
        ...
        CsvExport.exportVariablesToFile "foodtruck.party.slicemap" solution.DecisionResults CsvExport.csvConfig
